...
function Header (){
    ...
    return (
      <div>
        ...
        <header class=" mb-4 bg-[#4a1721] flex items-center w-full  justify-between py-4 md:mb-12 md:py-8 xl:mb-16">
                ...
                <a href="/login" class=" rounded-lg bg-white px-8 py-3 text-center text-sm font-semibold text-black outline-none ring-[#46052D] transition duration-100 hover:bg-[#1e0e18] hover:text-white focus-visible:ring active:text-black-700 md:text-base lg:inline-block">Login</a>
