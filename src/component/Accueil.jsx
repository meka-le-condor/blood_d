...
function Accueil () {
    ...
    return (
      <>
     <div class="acceuil bg-white pb-6 sm:pb-8 lg:pb-12">
      <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <a href="/about" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-[#46052D] active:text-indigo-700">About us</a>
        <a href="/register" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-[#46052D] active:text-indigo-700">Register_donor</a>
        <a href="/findblood" class="text-lg font-semibold text-gray-600 transition duration-100 hover:text-[#46052D] active:text-indigo-700">FindBlood</a>
      </nav>
        <a href="/login" class="hidden rounded-lg bg-black px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-white hover:text-black focus-visible:ring active:text-black-700 md:text-base lg:inline-block">Login</a>
            ...
            <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
                ...
                <div class="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
                  ...
                  <div class="flex flex-col gap-2.5 sm:flex-row sm:justify-center lg:justify-start">
                    <a href="#" class="inline-block rounded-lg bg-[#46052D] px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-black focus-visible:ring active:bg-indigo-700 md:text-base">Start now</a>
                ...
                <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                  <div class="flex flex-col items-center rounded-lg bg-gray-100 p-4 sm:p-8">
                    ...
                    <form class="mb-3 flex w-full max-w-md gap-2 sm:mb-5">
                      ...
                      <button class="inline-block rounded bg-[#46052D] px-8 py-2 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-black focus-visible:ring active:bg-indigo-700 md:text-base">Send</button>
                    </form>
